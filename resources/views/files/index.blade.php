                ...
                <table class="table table-condensed table-striped">
                    <thead>
                        <tr>
                            ...
                            <th>User</th> <th>Name</th> <th>Description</th> <th>Path</th> <th>Type</th> <th>Ststus</th>
                    ...
                    <tbody>
                        @foreach($files as $file)
                            <tr>
                                ...
                                <td>{{$file->user}}</td> <td>{{$file->name}}</td> <td>{{$file->description}}</td> <td>{{$file->path}}</td> <td>{{$file->type}}</td> <td>{{$file->ststus}}</td>
